    ...
    <>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mb-4'>
        ...
        <div className='w-full grid grid-cols-3'>
          <p
            className={`border rounded px-2 py-1 ${age ? "text-gray-800" : "text-gray-400"} `}>
            {age || ""} {age ? "Years Old" : "Date Of Birth"}
          </p>
          <input
            type='date'
            name='dateOfBirth'
            value={formPersonalData.dateOfBirth}
            onChange={handleChangePersonal}
        ...
        <Input
          type='text'
          name='contact_no'
          value={formPersonalData.contact_no}
          onChange={handleChangePersonal}
      ...
      <div className='mb-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 mt-1'>
          <Input
            ...
            value={formPersonalData.emergency_contact_name}
            onChange={handleChangePersonal}
            placeholder='Name'
            className='border rounded px-2 py-1'
          />
          <Input
            ...
            value={formPersonalData.emergency_contact_no}
            onChange={handleChangePersonal}
            placeholder='Mobile No.'
            className='border rounded px-2 py-1'
          />
