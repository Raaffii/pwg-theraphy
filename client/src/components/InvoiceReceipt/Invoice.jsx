...
import InvoiceSetup from "../Pos/InvoiceSetup";
  ...
  return (
    <div className='min-h-screen bg-gray-100 flex flex-col items-center py-10'>
      ...
      <div className='mt-8 space-y-2 w-full max-w-lg'>
        <Button
          onClick={() => console.log("Back to POS")}
          className='px-4 py-2 bg-purple-600 text-white rounded hover:bg-blue-600 w-full'>
          Back To Pos
        </Button>
        <Button
          onClick={handlePrint}
          className='px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-900 w-full'>
          Print Invoice
        </Button>
      </div>
